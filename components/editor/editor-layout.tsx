  ...
  return (
    <div className="flex h-screen w-full bg-neutral-50 overflow-hidden">
      ...
      <div className="flex-1 flex flex-col min-w-0 relative">
        ...
        {/* Scrollable Canvas */}
        <main className="flex-1 overflow-y-auto scroll-smooth bg-neutral-100/30 relative">
      ...
      <aside className="w-80 shrink-0 bg-white border-l border-neutral-200 flex flex-col z-20 shadow-xl">
        {sidebar}
      </aside>
    </div>
  );
